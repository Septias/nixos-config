{pkgs, ...}: {
  ...
  in {
    ...
    extraConfig = ''
        ...
        hl.bind("XF86AudioLowerVolume", hl.dsp.exec_cmd("${pkgs.pamixer}/bin/pamixer -d 5"), { locked = true, repeating = true })
        hl.bind("XF86AudioMute", hl.dsp.exec_cmd("${pkgs.pamixer}/bin/pamixer -t"), { locked = true, repeating = true })
        hl.bind("XF86AudioPlay", hl.dsp.exec_cmd("${pkgs.playerctl}/bin/playerctl play-pause"), { locked = true, repeating = true })
        hl.bind("XF86AudioPause", hl.dsp.exec_cmd("${pkgs.playerctl}/bin/playerctl play-pause"), { locked = true, repeating = true })
        hl.bind("XF86AudioNext", hl.dsp.exec_cmd("${pkgs.playerctl}/bin/playerctl next"), { locked = true, repeating = true })
        hl.bind("XF86AudioPrev", hl.dsp.exec_cmd("${pkgs.playerctl}/bin/playerctl prev"), { locked = true, repeating = true })
        hl.bind("SUPER + ALT + n", hl.dsp.exec_cmd("${pkgs.playerctl}/bin/playerctl next"), { locked = true, repeating = true })
        hl.bind("SUPER + ALT + s", hl.dsp.exec_cmd("${pkgs.playerctl}/bin/playerctl play-pause"), { locked = true, repeating = true })
